...
def main():
	...
	while True:  # main loop
		# detect button press and toggle pen state
			...
			y_value = map_potentiometer(right_knob.read_u16(), 0, 65535, 1, 215.9) #8,5in = 215.9mm
			# x_value, y_value = 100, 10
			...
			# alpha = map_potentiometer(left_knob.read_u16(), 0, 65535, 0, 215)
			# beta = map_potentiometer(right_knob.read_u16(), 0, 65535, 0, 180)
